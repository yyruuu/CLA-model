...
import numpy as np
from keras.layers import Input, Dense, LSTM, Conv1D, Dropout, Bidirectional, Multiply, Permute, Flatten, MaxPooling1D, RepeatVector, Reshape, SimpleRNN
...
def main(test_X, test_y):
    m = cnn_lstm(TIME_STEPS, INPUT_DIMS)
